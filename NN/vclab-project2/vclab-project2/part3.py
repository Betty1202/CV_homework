...
class ThreeLayerConvNet(nn.Module):
    def __init__(self, in_channel, channel_1, channel_2, num_classes):
        ...
        ########################################################################
        self.conv1 = nn.Conv2d(in_channel, channel_1, (5, 5), padding=(2, 2))
        nn.init.kaiming_normal_(self.conv1.weight)
        self.conv2 = nn.Conv2d(channel_1, channel_2, (3, 3), padding=(1, 1))
    ...
    def forward(self, x):
        ...
        ########################################################################
        conv1_hidden = self.conv1(x)
        conv1_relu = self.relu(conv1_hidden)

        conv2_hidden = self.conv2(conv1_relu)
        conv2_relu = self.relu(conv2_hidden)
