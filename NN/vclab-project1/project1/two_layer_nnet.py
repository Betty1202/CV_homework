...
hidden_size = [75, 100, 125, 150]
learning_rates = np.array([0.8, 1, 1.2]) * 1e-3
...
for hs in hidden_size:
    for lr in learning_rates:
        for reg in regularization_strengths:
            ...
            print(f"hidden size {hs}, learning rate {lr}, regularization strengths {reg} --> val acc: {val_acc}")
print("Finshed")

print(f'Best model:',
      f'hidden size {best_hs}, learning rate {best_lr}, regularization strengths {best_reg} --> val acc: {best_val_acc}')
