...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_layer, n_classes=1000, input_channels=3):
        ...
        self.in_channels = 64
        self.conv1 = nn.Conv2d(input_channels, 64, kernel_size=3, stride=1, padding=1, bias=False)  # 7->3
        self.bn1 = nn.BatchNorm2d(64)
        self.maxpool = nn.MaxPool2d(3, stride=1, padding=1)  # stride 2 -> 1
        self.relu = nn.ReLU(inplace=True)
        ...
        self.avgpool = nn.AvgPool2d(kernel_size=4, stride=4)  # 7->4
